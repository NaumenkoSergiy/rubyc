  ...
  def index
    ...
    @posts =    Post.published.recent
		...
		@day1 = [
			...
			{ time: "12:20", speaker: "Marat Kamenshikov, Svitla" },
			{ time: "13:00", title: "Lunch", class: 'item-break' },
			{ time: "14:00", speaker: "Kirill Timofeev, Dataart", title: "A trip to Lambda land" },
			...
			{ time: "15:40", speaker: "Cofee break, Video", title: "Kevin Triplett - Two Cartoon Foxes, the why documentary", class: 'item-break' },
		...
		@day2 = [
			...
			{ time: "15:40", speaker: "Second cofee break", title: "Kevin Triplett - video film", class: 'item-break' },
